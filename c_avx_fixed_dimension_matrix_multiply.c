...
typedef struct
{
    ...
    SAL_cf32 *left_matrix_rows[CMAT_MULX_FIXED_DIMENSION_MAX_NR_C];
    SAL_cf32 *right_matrix_rows[CMAT_MULX_FIXED_DIMENSION_MAX_DOT_PRODUCT_LENGTH];
    SAL_cf32 *output_matrix_rows[CMAT_MULX_FIXED_DIMENSION_MAX_NR_C];
