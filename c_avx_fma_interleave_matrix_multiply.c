...
static void timed_c_matrix_multiply (void *arg)
{
    ...
    context->rc = cmat_mulx_avx_fma_dot_product_length_8 (context->left_matrix, context->left_matrix_tcols,
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if ((context.nr_c <= NR_C_MAX) && (context.dot_product_length == 8))
    {
        ...
        context.output_matrix = mxCalloc_and_touch (context.nr_c * context.output_matrix_tcols, sizeof(SAL_cf32));
