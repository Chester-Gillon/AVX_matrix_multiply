                                                            ...
                                                            SAL_i32 nc_c)    /* column count in C */
{
    ...
    for (c_c = 0; c_c < nc_c; c_c += 4)
    {
        ...
        _mm256_storeu_ps (&(C[13] + c_c)->real, _mm256_add_ps (output_r13, _mm256_addsub_ps (_mm256_mul_ps (right_r_i, left_r13_c1_r),
                                                                                             _mm256_mul_ps (right_i_r, left_r13_c1_i))));
        _mm256_storeu_ps (&(C[14] + c_c)->real, _mm256_add_ps (output_r14, _mm256_addsub_ps (_mm256_mul_ps (right_r_i, left_r14_c1_r),
                                                                                             _mm256_mul_ps (right_i_r, left_r14_c1_i))));
        _mm256_storeu_ps (&(C[15] + c_c)->real, _mm256_add_ps (output_r15, _mm256_addsub_ps (_mm256_mul_ps (right_r_i, left_r15_c1_r),
                                                                                             _mm256_mul_ps (right_i_r, left_r15_c1_i))));
        _mm256_storeu_ps (&(C[16] + c_c)->real, _mm256_add_ps (output_r16, _mm256_addsub_ps (_mm256_mul_ps (right_r_i, left_r16_c1_r),
                                                                                             _mm256_mul_ps (right_i_r, left_r16_c1_i))));
        _mm256_storeu_ps (&(C[17] + c_c)->real, _mm256_add_ps (output_r17, _mm256_addsub_ps (_mm256_mul_ps (right_r_i, left_r17_c1_r),
                                                                                             _mm256_mul_ps (right_i_r, left_r17_c1_i))));
        _mm256_storeu_ps (&(C[18] + c_c)->real, _mm256_add_ps (output_r18, _mm256_addsub_ps (_mm256_mul_ps (right_r_i, left_r18_c1_r),
                                                                                             _mm256_mul_ps (right_i_r, left_r18_c1_i))));
        _mm256_storeu_ps (&(C[19] + c_c)->real, _mm256_add_ps (output_r19, _mm256_addsub_ps (_mm256_mul_ps (right_r_i, left_r19_c1_r),
