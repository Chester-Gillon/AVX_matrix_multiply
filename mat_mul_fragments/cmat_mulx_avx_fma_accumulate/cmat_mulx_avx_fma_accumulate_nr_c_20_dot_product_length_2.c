                                                                ...
                                                                SAL_i32 nc_c)    /* column count in C */
{
    ...
    for (c_c = 0; c_c < nc_c; c_c += 4)
    {
        ...
        right_i_r = _mm256_permute_ps (right_r_i, SWAP_REAL_IMAG_PERMUTE);
        _mm256_store_ps (&(C[0] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r0_c1_r,
                                                               _mm256_fmadd_ps (right_i_r, left_r0_c1_i, output_r0)));
        _mm256_store_ps (&(C[1] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r1_c1_r,
                                                               _mm256_fmadd_ps (right_i_r, left_r1_c1_i, output_r1)));
        _mm256_store_ps (&(C[2] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r2_c1_r,
                                                               _mm256_fmadd_ps (right_i_r, left_r2_c1_i, output_r2)));
        _mm256_store_ps (&(C[3] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r3_c1_r,
                                                               _mm256_fmadd_ps (right_i_r, left_r3_c1_i, output_r3)));
        _mm256_store_ps (&(C[4] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r4_c1_r,
                                                               _mm256_fmadd_ps (right_i_r, left_r4_c1_i, output_r4)));
        _mm256_store_ps (&(C[5] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r5_c1_r,
                                                               _mm256_fmadd_ps (right_i_r, left_r5_c1_i, output_r5)));
        _mm256_store_ps (&(C[6] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r6_c1_r,
                                                               _mm256_fmadd_ps (right_i_r, left_r6_c1_i, output_r6)));
        _mm256_store_ps (&(C[7] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r7_c1_r,
                                                               _mm256_fmadd_ps (right_i_r, left_r7_c1_i, output_r7)));
        _mm256_store_ps (&(C[8] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r8_c1_r,
                                                               _mm256_fmadd_ps (right_i_r, left_r8_c1_i, output_r8)));
        _mm256_store_ps (&(C[9] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r9_c1_r,
                                                               _mm256_fmadd_ps (right_i_r, left_r9_c1_i, output_r9)));
        _mm256_store_ps (&(C[10] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r10_c1_r,
                                                                _mm256_fmadd_ps (right_i_r, left_r10_c1_i, output_r10)));
        _mm256_store_ps (&(C[11] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r11_c1_r,
                                                                _mm256_fmadd_ps (right_i_r, left_r11_c1_i, output_r11)));
        _mm256_store_ps (&(C[12] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r12_c1_r,
                                                                _mm256_fmadd_ps (right_i_r, left_r12_c1_i, output_r12)));
        _mm256_store_ps (&(C[13] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r13_c1_r,
                                                                _mm256_fmadd_ps (right_i_r, left_r13_c1_i, output_r13)));
        _mm256_store_ps (&(C[14] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r14_c1_r,
                                                                _mm256_fmadd_ps (right_i_r, left_r14_c1_i, output_r14)));
        _mm256_store_ps (&(C[15] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r15_c1_r,
                                                                _mm256_fmadd_ps (right_i_r, left_r15_c1_i, output_r15)));
        _mm256_store_ps (&(C[16] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r16_c1_r,
                                                                _mm256_fmadd_ps (right_i_r, left_r16_c1_i, output_r16)));
        _mm256_store_ps (&(C[17] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r17_c1_r,
                                                                _mm256_fmadd_ps (right_i_r, left_r17_c1_i, output_r17)));
        _mm256_store_ps (&(C[18] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r18_c1_r,
                                                                _mm256_fmadd_ps (right_i_r, left_r18_c1_i, output_r18)));
        _mm256_store_ps (&(C[19] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r19_c1_r,
