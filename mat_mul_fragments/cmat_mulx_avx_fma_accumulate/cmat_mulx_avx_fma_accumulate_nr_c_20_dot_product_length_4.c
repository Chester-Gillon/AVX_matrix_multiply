                                                                ...
                                                                SAL_i32 nc_c)    /* column count in C */
{
    ...
    for (c_c = 0; c_c < nc_c; c_c += 4)
    {
        ...
        _mm256_store_ps (&(C[7] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r7_c3_r,
                                                               _mm256_fmadd_ps (right_i_r, left_r7_c3_i, output_r7)));
        _mm256_store_ps (&(C[8] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r8_c3_r,
                                                               _mm256_fmadd_ps (right_i_r, left_r8_c3_i, output_r8)));
        _mm256_store_ps (&(C[9] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r9_c3_r,
                                                               _mm256_fmadd_ps (right_i_r, left_r9_c3_i, output_r9)));
        _mm256_store_ps (&(C[10] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r10_c3_r,
                                                                _mm256_fmadd_ps (right_i_r, left_r10_c3_i, output_r10)));
        _mm256_store_ps (&(C[11] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r11_c3_r,
                                                                _mm256_fmadd_ps (right_i_r, left_r11_c3_i, output_r11)));
        _mm256_store_ps (&(C[12] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r12_c3_r,
                                                                _mm256_fmadd_ps (right_i_r, left_r12_c3_i, output_r12)));
        _mm256_store_ps (&(C[13] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r13_c3_r,
                                                                _mm256_fmadd_ps (right_i_r, left_r13_c3_i, output_r13)));
        _mm256_store_ps (&(C[14] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r14_c3_r,
                                                                _mm256_fmadd_ps (right_i_r, left_r14_c3_i, output_r14)));
        _mm256_store_ps (&(C[15] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r15_c3_r,
                                                                _mm256_fmadd_ps (right_i_r, left_r15_c3_i, output_r15)));
        _mm256_store_ps (&(C[16] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r16_c3_r,
                                                                _mm256_fmadd_ps (right_i_r, left_r16_c3_i, output_r16)));
        _mm256_store_ps (&(C[17] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r17_c3_r,
                                                                _mm256_fmadd_ps (right_i_r, left_r17_c3_i, output_r17)));
        _mm256_store_ps (&(C[18] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r18_c3_r,
                                                                _mm256_fmadd_ps (right_i_r, left_r18_c3_i, output_r18)));
        _mm256_store_ps (&(C[19] + c_c)->real, _mm256_fmadd_ps (                 right_r_i, left_r19_c3_r,
